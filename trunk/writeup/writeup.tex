...
\includegraphics[width=1\linewidth]{graph_speedup_vs_particle_size}
...
\includegraphics[width=1\linewidth]{graph_best_time_vs_particle_size}
...
\includegraphics[width=1\linewidth]{graph_cores}
