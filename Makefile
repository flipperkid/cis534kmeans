...
Kmeans_omp: 	Makefile code/*
	g++ -o Kmeans_omp code/kmeans.cpp code/Kmeans_demo_omp.cpp code/timer.cpp code/kmeans_omp.cpp -I ~cis534/public/tbb/include/ -L ~cis534/public/tbb/build/linux_intel64_gcc_cc4.3.2_libc2.9_kernel2.6.27.29_release -I opencv/include/opencv -L opencv/lib64 -lcv -lcvaux -lcxcore -lhighgui -lml -ltbb -O3
