...
int kmeans_tbb(uchar *particle_data, int particle_count, int dimensions, int cluster_count, uchar *assignments, int grainSizeStep1) {
    reset_timer();
//    srand( time(NULL) );
